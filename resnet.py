...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks,input_channels, num_classes=10):
        ...
        self.conv1 = nn.Conv2d(input_channels, 64, kernel_size=3, stride=1, padding=1, bias=False) #change the first parameter when the images are not grayscale
...
# Create an instance of the ResNet network with customizable number of classes
